...
function plant(world)
    ...
    for _,tile in pairs(getBot():getWorld():getTiles()) do
        ...
        if not dontPlant and getBot():getWorld():getTile(tile.x, tile.y + 1):hasFlag(0) and (getBot():getWorld():hasAccess(tile.x, tile.y) and tile.fg == 0 and getBot():getWorld():getTile(tile.x, tile.y + 1).fg ~= 0 and getBot():getWorld():getTile(tile.x, tile.y + 1).fg ~= itmId) then
